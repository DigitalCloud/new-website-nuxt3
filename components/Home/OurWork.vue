  ...
  <div class="mb-16">
      ...
      <div class="flex flex-nowrap items-center -mx-4 md:mx-0">
        <ClientOnly>
          ...
          >
            ...
            <swiper-slide>
              <button
                :class="{ active: activeWorkClass === 'all' }"
                class="bg-gray-300 p-font text-lg sm:text-sm font-bold p-2.5 rounded-md changeWorkSlideBtn"
                @click="activeWorkSlide('all')"
              >
                All Projects
              </button>
            </swiper-slide>
            <swiper-slide>
              <button
                :class="{ active: activeWorkClass === 'web' }"
                class="bg-gray-300 p-font text-lg sm:text-sm font-bold p-2.5 rounded-md changeWorkSlideBtn"
                @click="activeWorkSlide('web')"
              >
                Web Development
              </button>
            </swiper-slide>
            <swiper-slide>
              <button
                :class="{ active: activeWorkClass === 'mobile' }"
                class="bg-gray-300 p-font text-lg sm:text-sm font-bold p-2.5 rounded-md changeWorkSlideBtn"
                @click="activeWorkSlide('mobile')"
              >
                Mobile Development
              </button>
            </swiper-slide>
            <swiper-slide>
              <button
                :class="{ active: activeWorkClass === 'marketing' }"
                class="bg-gray-300 p-font text-lg sm:text-sm font-bold p-2.5 rounded-md changeWorkSlideBtn"
                @click="activeWorkSlide('marketing')"
              >
                Digital Marketing
              </button>
            </swiper-slide>
    ...
    <div class="flow-container mt-8 md:mt-6">
      <ClientOnly>
        ...
        <swiper
          v-if="activeWorkClass === 'marketing'"
          key="marketingSlide"
          :spaceBetween="10"
          :watchSlidesProgress="true"
          class="work-swiper free-mode-swiper"
